...
<div class="container mt-5">
    <div class="card shadow-lg border-0 rounded-3">
        <div class="card-header bg-primary text-white">
            <h3 class="mb-0">Ajouter un Neussites</h3>
        </div>
        <div class="card-body">
            <x-alert-sweet />
            ...
            <form action="{{ route('neussites.store') }}" method="POST">
                @csrf
                <div class="mb-3">

                    <label for="intervention_id" class="form-label fw-bold">Intervention</label>
                    <select class="form-control" id="intervention_id" name="intervention_id" >
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" id="piece_id" name="piece_id" >
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" id="date_change" name="date_change" value="{{ old('date_change') }}" >
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" class="form-control" id="prix_piece" name="prix_piece" value="{{ old('prix_piece') }}" >
                </div>

                <div class="mb-3">
                    <label for="nom_technicien" class="form-label fw-bold">Nom du Technicien</label>
                    <input type="text" class="form-control" id="nom_technicien" name="nom_technicien" value="{{ old('nom_technicien') }}" >
                </div>
