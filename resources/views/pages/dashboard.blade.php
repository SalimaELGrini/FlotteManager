...
@section('content')
@include('layouts.navbars.auth.topnav', ['title' =>  __('dashboard.dashboard')])
...
@php 
    $charts = [
        ['id' => 'fuelCostsByMonthChart', 'title' => __('dashboard.fuel_expenses'), 'desc' => __('dashboard.fuel_expenses_desc'), 'icon' => 'fa fa-gas-pump', 'iconColor' => 'text-primary'],
        ['id' => 'costByMonthChart', 'title' => __('dashboard.intervention_costs'), 'desc' => __('dashboard.intervention_costs_desc'), 'icon' => 'fa fa-dollar-sign', 'iconColor' => 'text-primary'],
        ['id' => 'interventionsByMonthChart', 'title' => __('dashboard.interventions_by_month'), 'desc' => __('dashboard.interventions_by_month_desc'), 'icon' => 'fa fa-chart-line', 'iconColor' => 'text-primary'],
        ['id' => 'interventionsByVehicleChart', 'title' => __('dashboard.interventions_by_vehicle'), 'desc' => __('dashboard.interventions_by_vehicle_desc'), 'icon' => 'fa fa-car', 'iconColor' => 'text-primary'],
        ['id' => 'interventionsByTypeChart', 'title' => __('dashboard.interventions_by_type'), 'desc' => __('dashboard.interventions_by_type_desc'), 'icon' => 'fa fa-cogs', 'iconColor' => 'text-primary'],
    ];
@endphp
